        ...
        <div className="capability-market-container">
            <div className="cap-market-header">
                <div className="cap-market-title-area">
                    ...
                    <Button variant="ghost" size="sm" iconOnly className="cap-btn-icon" onClick={onClose} aria-label={t('common.close')}>
                        <X size={20} />
                    </Button>
                </div>
                    ...
                    {filteredItems.map(item => {
                        ...
                        return (
                            <div key={item.id} className="cap-card">
                                ...
                                {status === 'installed' ? (
                                    <Button variant="secondary" tone="subtle" size="sm" className="cap-btn-installed" disabled>
